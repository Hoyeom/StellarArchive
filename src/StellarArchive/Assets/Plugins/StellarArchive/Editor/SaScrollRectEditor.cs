...
{
    [CustomEditor(typeof(SaScrollRect), true)]
    [CanEditMultipleObjects]
    public class SaScrollRectEditor : Editor
    {
        ...
        {
            SetAnimBool(_showElasticity, !_movementType.hasMultipleDifferentValues && _movementType.enumValueIndex == (int)SaScrollRect.MovementType.Elastic, instant);
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((SaScrollRect)target).transform;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (_horizontalScrollbar.objectReferenceValue && !_horizontalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((SaScrollRect.ScrollbarVisibility)_horizontalScrollbarVisibility.enumValueIndex == SaScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
            ...
            if (_verticalScrollbar.objectReferenceValue && !_verticalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((SaScrollRect.ScrollbarVisibility)_verticalScrollbarVisibility.enumValueIndex == SaScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
            ...
            EditorGUILayout.PropertyField(_testPrefab);
